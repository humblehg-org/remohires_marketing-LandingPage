...
const perks = [
  ...
  "Google Meet",
  "No obligation",
  "Discuss your agency's bottlenecks",
  "See how the agent would run for you",
];

export default function AiInsuranceThankYouPage() {
  return (
    <>
      <header>
      ...
      <section className="ty-section">
        <div className="wrap ty-wrap">
          ...
          <p className="ty-sub">Our team will review your agency&rsquo;s bottlenecks shortly.</p>
          <p className="ty-sub">
