...
// embedded — same pair automation-engineer/thank-you uses. Re-resolve
// BOOKING_URL's redirect target if the schedule ever changes and this
// embed goes blank.
...
const RemoHiresLogo = ({ className }: { className?: string }) => (
  <svg
    role="img"
    aria-label="RemoHires"
    className={className}
    viewBox="0 0 174 44"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#chatgpt-automation-ty-logo-clip)">
    ...
    <defs>
      <clipPath id="chatgpt-automation-ty-logo-clip">
...
export default function ChatgptAutomationThankYouPage() {
  return (
    <div id="chatgpt-automation-page" className={`${styles.page} ${inter.variable} ${jetbrainsMono.variable}`}>
      <header className={`${styles.header} ${styles.headerShadow}`}>
        <div className={styles.headerBar}>
          <a href="https://remohires.com" target="_blank" rel="noopener" className={styles.headerLogoLink}>
            <RemoHiresLogo className={styles.logo} />
          </a>
        </div>
      </header>

      <section className={styles.tyFinal}>
        <div className={styles.tyBox}>
          <span className={styles.eyebrow}>Request received</span>
          <h2 className={styles.tyHeading}>✅ Thanks! We&rsquo;ve received your request.</h2>
          <p className={styles.tyText}>
            Our team will review your workflows shortly. To speed up the process, book a free 15-minute fit call
          ...
          <div className={styles.bookingCard}>
            <div className={styles.bookingHead}>
              ...
              <h2 className={styles.bookingHeadTitle}>Book your call — no obligation</h2>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className={`${styles.btn} ${styles.btnPrimary} ${styles.bookingCta}`}
            >
              Open booking page in a new tab <span className={styles.arw}>&rarr;</span>
            </a>
            <p className={styles.bookingNote}>
              Booking is optional — we&rsquo;ve already got your request and will follow up either way.
            </p>
          </div>

          <a href="https://remohires.com" target="_blank" rel="noopener" className={styles.tyBack}>
            ← Back to RemoHires
          </a>
        </div>
      </section>
        ...
        <div className={styles.footerRow}>
          <div className={styles.footerBrand}>
            ...
            <p className={styles.footerTagline}>
              A dedicated remote team member for the work you can&rsquo;t afford to hire for locally.
            </p>
          </div>
          <nav className={styles.footerNav}>
            ...
            <a href="/termsofservice" className={styles.footerLink}>
              Terms
            </a>
            <a href="mailto:info@remohires.com" className={styles.footerLink}>
              info@remohires.com
            </a>
          </nav>
