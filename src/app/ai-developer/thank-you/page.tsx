...
export default function AiDeveloperThankYouPage() {
  return (
    <div className="page">
      ...
      <section className="ty-section">
        <div className="container ty-wrap">
          ...
          <p className="ty-sub">Our team will review your AI build request shortly.</p>
          <p className="ty-sub">
          ...
          <div className="booking-card">
            ...
            <a href={BOOKING_URL} target="_blank" rel="noopener" className="button button-primary booking-cta">
