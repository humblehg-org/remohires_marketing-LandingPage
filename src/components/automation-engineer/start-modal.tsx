 ...
 * button without prop-drilling a shared modal state through page.tsx.
 */
export function StartModal() {
  ...
  useEffect(() => {
    ...
    const focusTimer = window.setTimeout(() => {
      // Skip the hidden Web3Forms fields (access_key/subject/from_name/
      // botcheck) that come first in the DOM — focus the actual first
      // visible field (Name) instead.
      panelRef.current
