...
/**
 * Replaces the Cal.com booking embed on /virtual-assistant with a phone
          ...
          <form ref={formRef} noValidate onSubmit={handleSubmit}>
            ...
            <div style={step === "details" ? undefined : { display: "none" }}>
              ...
              <div className="callback-field">
                ...
                <input id="va-cb-name" type="text" name="name" required disabled={pending} />
              </div>
              <div className="callback-field">
                <label htmlFor="va-cb-company">Company *</label>
                <input id="va-cb-company" type="text" name="company" required disabled={pending} />
              </div>
              <div className="callback-field">
                <label htmlFor="va-cb-email">Work Email *</label>
                <input id="va-cb-email" type="email" name="email" required disabled={pending} />
              </div>
              <div className="callback-field">
                <label htmlFor="va-cb-phone">Phone Number *</label>
                <input id="va-cb-phone" type="tel" name="phone" required disabled={pending} />
              </div>
              ...
              <div>
                ...
                {callbackType === "scheduled" && (
                  <div className="callback-schedule-fields">
                    <div className="callback-field">
                      <label htmlFor="va-cb-date">Preferred Date *</label>
                      <input id="va-cb-date" type="date" name="preferred_date" required disabled={pending} />
                    </div>
                    <div className="callback-field">
                      <label htmlFor="va-cb-time">Preferred Time *</label>
                      <input id="va-cb-time" type="time" name="preferred_time" required disabled={pending} />
                    </div>
                    <div className="callback-field">
                      <label htmlFor="va-cb-tz">Timezone *</label>
                      <select id="va-cb-tz" name="timezone" required disabled={pending} defaultValue="">
