...
const PAGE_PATH = "/customer-services";
      ...
      <div className="box" ref={panelRef} role="dialog" aria-modal="true" aria-labelledby="lm-title">
        ...
        {successMessage ? (
          ...
          <form ref={formRef} noValidate onSubmit={handleSubmit}>
            ...
            <input type="hidden" name="subject" value="New customer service lead — RemoHires" />
            ...
            <h4 id="lm-title">Get Someone On Your Customer Support</h4>
            ...
            <ul className="whatnext">
              ...
              <li>You approve the person before they touch a single customer call or ticket</li>
            </ul>
