...
/**
 * Replaces the Cal.com booking embed on /custom-recruitment with a phone
      ...
      >
        ...
        {success ? (
          <div className="callback-success">
            ...
            <button type="button" className="btn btn-primary callback-submit" onClick={() => setOpen(false)}>
              Close
            </button>
          </div>
        ) : (
          <form ref={formRef} noValidate onSubmit={handleSubmit}>
            ...
            <div style={step === "details" ? undefined : { display: "none" }}>
              ...
              <div className="callback-field">
                <label htmlFor="cr-cb-name">Name *</label>
                <input id="cr-cb-name" type="text" name="name" required disabled={pending} />
              </div>
              <div className="callback-field">
                <label htmlFor="cr-cb-company">Company *</label>
                <input id="cr-cb-company" type="text" name="company" required disabled={pending} />
              </div>
              <div className="callback-field">
                <label htmlFor="cr-cb-email">Work Email *</label>
                <input id="cr-cb-email" type="email" name="email" required disabled={pending} />
              </div>
              <div className="callback-field">
                <label htmlFor="cr-cb-phone">Phone Number *</label>
                <input id="cr-cb-phone" type="tel" name="phone" required disabled={pending} />
              </div>
              <button type="button" className="btn btn-primary callback-submit" onClick={handleContinue}>
                Continue
              </button>
            </div>
              ...
              <div>
                ...
                {callbackType === "scheduled" && (
                  <div className="callback-schedule-fields">
                    <div className="callback-field">
                      <label htmlFor="cr-cb-date">Preferred Date *</label>
                      <input id="cr-cb-date" type="date" name="preferred_date" required disabled={pending} />
                    </div>
                    <div className="callback-field">
                      <label htmlFor="cr-cb-time">Preferred Time *</label>
                      <input id="cr-cb-time" type="time" name="preferred_time" required disabled={pending} />
                    </div>
                    <div className="callback-field">
                      <label htmlFor="cr-cb-tz">Timezone *</label>
                      <select id="cr-cb-tz" name="timezone" required disabled={pending} defaultValue="">
                ...
                {callbackType && (
                  <button type="submit" className="btn btn-primary callback-submit" disabled={pending}>
