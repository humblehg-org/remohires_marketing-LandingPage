...
export const OPEN_START_MODAL_EVENT = "chatgpt-automation:open-start-modal";

/**
 * Shared handler for every "Start for $49" entry point on the
 * /chatgpt-automation landing page. GTM itself is already loaded once,
 * sitewide, via <GoogleTagManager> in the root layout — this only pushes
 * the event, it does not re-init GTM.
 */
