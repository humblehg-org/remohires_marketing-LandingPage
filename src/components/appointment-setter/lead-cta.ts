 ...
 * OPEN_CALLBACK_MODAL_EVENT pattern used on /virtual-assistant. */
export const OPEN_LEAD_MODAL_EVENT = "appointment-setter:open-lead-modal";

/**
 * Shared click handler for every booking CTA on /appointment-setter. Replaces
...
export function handleOpenLeadModal(ctaName: string) {
  return (e: MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    sendGTMEvent({ event: "booking_cta_click", cta_name: ctaName, page_path: "/appointment-setter" });
