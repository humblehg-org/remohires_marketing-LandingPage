...
const LINES: Line[] = [
  { t: "9:02", a: false, html: "new lead · <b>website form</b> · wants a quote" },
  { t: "9:02", a: true, html: "auto-reply sent by text + email, in <b>your business’s name</b>" },
  { t: "9:03", a: true, html: "logged to your <b>CRM</b> + invoice drafted · once" },
  { t: "9:05", a: true, html: "flagged for <b>you</b> when it needs a human" },
  { t: "live", a: true, ok: true, html: "workflow running 24/7…" },
];
  ...
  return (
    <div className="term" id="term">
      <div className="bar">
        ...
        <span style={{ marginLeft: 8 }}>workflow · your business</span>
      ...
      <div className="body" id="termbody">
        {completed.map((line, idx) => (
          <div className={`tline show${line.ok ? " ok" : ""}`} key={idx}>
            ...
            <span className="arrow">{line.a ? "auto →" : "•"}</span>
        ...
        {current && (
          <div className={`tline show${current.line.ok ? " ok" : ""}`}>
            ...
            <span className="arrow">{current.line.a ? "auto →" : "•"}</span>
            <span className="c">
