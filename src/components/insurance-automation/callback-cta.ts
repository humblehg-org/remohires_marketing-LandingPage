...
export const OPEN_CALLBACK_MODAL_EVENT = "insurance-automation:open-callback-modal";

/**
 * Shared click handler for every booking CTA on /insurance-automation.
 * Replaces the previous Cal.com element-click embed: instead of data-cal-*
 * attributes, this fires the open event for <CallbackModal> and passes along
 * which CTA was clicked so the Web3Forms submission can record it.
 *
