 ...
 * /appointment-setter. */
export const OPEN_LEAD_MODAL_EVENT = "administrative-assistant:open-lead-modal";

/**
 * Shared click handler for every booking CTA on /administrative-assistant.
...
export function handleOpenLeadModal(ctaName: string) {
  return (e: MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    sendGTMEvent({ event: "booking_cta_click", cta_name: ctaName, page_path: "/administrative-assistant" });
